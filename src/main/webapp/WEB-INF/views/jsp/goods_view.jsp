	    ...
	    $.ajax({
            ...
            success: function (data) { // data 对应Controller return的变量
                ...
                html += "<table width=\"100%\" class=\"list_table m_10 mt_10\">"
					...
					+ "<tr><th>用户名</th><th>评星</th><th>评价</th><th>评价时间</th><th></th></tr></thead><tbody>";
				...
				<div name="showBox">
					...
					<div class="hidden comment_list box">
						<div class="title3">
							...
							<%--</span> --%>
							<img src="images/front/comm.gif" width="16px" height="16px" />商品评价<span class="f12 normal">
					...
					<%--	<c:if test="${not empty sessionScope.user}">
							<div>
								<form action="./comment/addComment" method="post">
									...
									&lt;%&ndash;<input type="hidden" name="targetId" value="db9efbd7c28b4c279f0d1f7cc4dd32b1" />&ndash;%&gt;
