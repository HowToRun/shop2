...
public interface OrderDetailDao {
	...
	public void updatesendStatusById(@Param("id")String id,
			@Param("sendStatus")Integer sendStatus,
			@Param("orderStatus")Integer orderStatus);
	public void deleteOrderDetailById(String oId);

	public void updateorderStatus(@Param("orderId")String orderId,
			@Param("orderStatus")Integer orderStatus);
}
